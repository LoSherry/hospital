...
CREATE TABLE `clinical_feature`  (
  ...
  `肿瘤位置` enum('右乳','左乳','双乳') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  ...
  `患侧乳头` enum('正常','凹陷','半固定','固定','湿疹样','乳头皴裂','乳头缺如','其他') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `转移部位` enum('肝','肺','骨','脑','其他') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  ...
  `确诊病理号` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  ...
  `新辅助治疗方案及周期` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `新辅助治疗过程评估` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `新辅助治疗疗效评价` enum('完全缓解','部分缓解','疾病进展','疾病稳定') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `术前治疗开始时间` date NULL DEFAULT NULL,
  `术前治疗方案及周期` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `术前治疗过程评估` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `术前治疗疗效评价` enum('完全缓解','部分缓解','疾病进展','疾病稳定') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`编号`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6001 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '临床特征表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `family_history`  (
  ...
  `亲属` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `postoperative_treatment`  (
  ...
  `术后化疗方案` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `relapse_information`  (
  ...
  `复发后治疗` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `surgical_pathological_info`  (
  ...
  `病理具体描述` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  ...
  `保乳手术标本周断端` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  ...
  PRIMARY KEY (`编号`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2001 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '手术病理信息' ROW_FORMAT = DYNAMIC;
